...
export function ProfileScreen({ navigate }: Props) {
  return (
    <div className="flex-1 overflow-y-auto pb-20 bg-gray-50 cursor-pointer">
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center">
            ...
            <span className="font-bold text-lg text-green-700">Rp 12.5M</span>
          </div>
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-center">
      ...
      <div className="mt-6 px-4 pb-4">
        <button 
          ...
          className="w-full bg-red-50 text-red-600 font-bold py-3.5 rounded-lg text-sm border border-red-100"
        >
          Keluar (Logout)
        </button>
      </div>
