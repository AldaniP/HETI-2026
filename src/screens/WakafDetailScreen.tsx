  ...
  return (
    <div className="flex-1 overflow-y-auto bg-gray-50 flex flex-col h-full relative">
      <div className="absolute top-0 left-0 right-0 p-4 flex items-center justify-between z-20">
        <button onClick={() => navigate('catalog')} className="w-10 h-10 bg-black/30 backdrop-blur-md rounded-full flex items-center justify-center text-white">
          <ArrowLeft size={24} />
        </button>
      ...
      <div className="bg-white rounded-t-3xl -mt-6 relative z-20 pb-24">
        <div className="p-5">
            <span className="text-xs bg-green-100 text-green-700 px-2.5 py-1 rounded-full font-bold mb-3 inline-block">Wakaf Pendidikan</span>
            ...
            <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 mb-6">
                <div className="flex justify-between items-end mb-2">
                    <div>
                        ...
                        <p className="text-xl font-bold text-green-600 border-b border-dashed border-green-300 pb-0.5">Rp 450.000.000</p>
                    </div>
            ...
            <div className="flex items-center space-x-3 p-4 bg-white border border-gray-100 rounded-xl shadow-sm mb-6 cursor-pointer" onClick={() => navigate('nazhir')}>
                <img src="https://images.unsplash.com/photo-1560179707-f14e90ef3623?auto=format&fit=crop&w=100&q=80" referrerPolicy="no-referrer" className="w-12 h-12 rounded bg-gray-100 object-cover p-1" />
