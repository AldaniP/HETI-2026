...
export function NazhirScreen({ navigate }: Props) {
  ...
  const activePrograms = [
    {
      ...
      themeBg: "bg-green-100 text-green-700"
    },
    {
      id: 2,
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-gray-50 flex flex-col h-full relative font-sans pb-16">
      ...
      <div className="relative h-44 w-full">
        ...
        <div className="absolute top-4 left-4 z-25 flex items-center">
          <button 
            ...
            className="bg-black/40 hover:bg-black/60 text-white rounded-full p-2.5 backdrop-blur-md transition-colors"
          >
        ...
        <div className="bg-white rounded-2xl border border-gray-150 p-5 shadow-sm space-y-4">
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-3.5">
              ...
              />
              <div>
                <h2 className="font-extrabold text-gray-905 text-base flex items-center">
                  Dompet Dhuafa
                </h2>
                <div className="mt-1 flex items-center text-[10px] font-black text-emerald-800 bg-emerald-50 border border-emerald-100 px-2 py-0.5 rounded-full w-fit">
          ...
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[9px] text-emerald-800/80 font-bold">{stat.sub}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-150 p-5 shadow-2xs space-y-4">
          ...
          <div className="space-y-3.5">
            {[
              ...
              { 
                icon: <Globe size={15} className="text-emerald-700" />, 
                title: 'Situs Web Resmi', 
                desc: 'dompetdhuafa.org',
                style: 'text-emerald-700 font-extrabold hover:underline'
              },
              { 
              ...
              <div key={idx} className="flex items-start">
                <div className="w-8 h-8 rounded-lg bg-emerald-50/70 border border-emerald-100/30 flex items-center justify-center mr-3 shrink-0 mt-0.5">
                  {contact.icon}
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[9.5px] font-bold text-gray-400 capitalize">{contact.title}</p>
                  <p className={`text-[11px] font-bold text-gray-750 leading-snug mt-0.5 truncate ${contact.style || ''}`}>
                    {contact.desc}
                  </p>
                </div>
              </div>
      ...
      <div className="px-4 mt-4">
        <div className="bg-white rounded-2xl border border-gray-150 p-5 shadow-2xs space-y-4">
              ...
              >
                <div className="flex items-center mr-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h4 className="text-[11px] font-extrabold text-gray-805 leading-snug truncate group-hover:text-emerald-800 transition">
                      {doc.name}
                    </h4>
                ...
                <div className="flex items-center shrink-0 pl-1">
                  <span className="text-[8.5px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-100 px-1.5 py-0.5 rounded mr-2 flex items-center">
                    <CheckCircle2 size={10} className="mr-0.5 shrink-0" /> SAH
                  </span>
                  <div className="text-gray-400 group-hover:text-emerald-700 transition">
                    <Download size={14} />
                  </div>
                </div>
              </button>
          ...
          {copiedDoc && (
            <div className="p-2.5 bg-emerald-800 text-white text-[10.5px] font-bold rounded-lg text-center shadow-xs animate-bounce.short">
      ...
      <div className="px-4 mt-5 space-y-3">
        <div className="flex justify-between items-center px-0.5">
          ...
          <span className="text-[10px] text-emerald-800 font-extrabold bg-emerald-50 border border-emerald-100 px-2 py-0.5 rounded-full">
        ...
        <div className="space-y-3.5">
          {activePrograms.map((program) => (
            <div 
              key={program.id} 
              onClick={() => navigate('wakaf_detail')}
              className="bg-white rounded-2xl shadow-sm border border-gray-150 hover:border-emerald-300 overflow-hidden flex cursor-pointer hover:shadow-xs transition duration-200"
            >
              <img 
                src={program.image} 
                referrerPolicy="no-referrer"
              ...
              <div className="p-3.5 flex-1 flex flex-col justify-between min-w-0">
                ...
                <div className="mt-2.5">
                  <div className="w-full bg-gray-100 rounded-full h-1.5 mb-1.5 border border-gray-200/20">
                    <div className="bg-emerald-600 h-1.5 rounded-full" style={{ width: `${program.progress}%` }}></div>
                  </div>
                  <div className="flex justify-between text-[9.5px]">
                    <span className="text-emerald-800 font-black">Terkumpul {program.collected}</span>
