  ...
  return (
    <div className="flex flex-col min-h-screen p-6 bg-white">
      <div className="flex-1 flex flex-col justify-center items-center">
        <AmwalLogo className="mb-6" size={180} />
        ...
        <form className="w-full space-y-4" onSubmit={(e) => { e.preventDefault(); navigate('home'); }}>
          ...
          <div>
            ...
            <div className="text-right mt-2">
              <button type="button" className="text-sm text-green-600 font-medium">Lupa password?</button>
            </div>
          </div>
      ...
      <div className="text-center pb-4 pt-8">
        <p className="text-sm text-gray-600">
          Belum punya akun? <button onClick={() => navigate('register')} className="text-green-600 font-bold">Daftar</button>
        </p>
      </div>
    </div>
  );
